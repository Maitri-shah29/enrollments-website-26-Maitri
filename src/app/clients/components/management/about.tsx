    ...
    <div className="relative bg-white/50 backdrop-blur-md rounded-2xl p-10 w-[90%] h-[90%] shadow-lg overflow-y-auto">
      ...
      <div className="text-black leading-relaxed space-y-4 text-base">
        ...
        <p>
          ...
          engaging content. We handle the behind-the-scenes madness so that ACM
          events aren&apos;t just good but unforgettable. If an event feels
          smooth, well-organized and just right, you can bet we had something to
          do with it.
        </p>
      </div>
    </div>
