...
export default function WhatWeDo() {
  return (
    <div className="relative bg-white/50 backdrop-blur-md rounded-2xl p-10 w-[90%] h-[90%] shadow-lg overflow-y-auto">
      ...
      <div className="text-black leading-relaxed space-y-4 text-base">
        <p>
          <strong>Marketing —</strong> We create all the hype around our events.
          We make sure every event looks amazing and gets the attention it
          deserves. I can't remember the last conversation where I didn't
          mention ExamCooker — because marketing shouldn't stop, right? Posters,
          captions, PR strategies — we do it all.
        </p>
